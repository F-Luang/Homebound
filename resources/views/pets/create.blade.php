    ...
    <div class="page" style="max-width:720px;">
        ...
        <form method="POST" action="{{ isset($pet) ? route('pets.update', $pet) : route('pets.store') }}"
            ...
            <div class="card" style="margin-bottom:16px;">
                ...
                <div class="form-group" style="margin-bottom:0;">
                    ...
                    <div style="font-size:11px;color:#888;margin-top:4px;">
                        Leave blank or set to 0 for sponsored / free adoptions. Shown on the pet's profile and recorded on the contract.
                    </div>
                </div>
            </div>
            ...
            <div class="card" style="margin-bottom:16px;">
                ...
                {{-- Upload field --}}
                <div class="form-group" style="margin-bottom:0;">
                    <label class="form-label">{{ isset($pet) ? 'Add more photos' : 'Upload photos' }}</label>
