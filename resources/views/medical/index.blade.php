            ...
            <div class="card">
                ...
                @if($records->isEmpty())
                    <div style="text-align:center;padding:40px 0;">
                        ...
                        <div style="font-size:14px;font-weight:500;color:#1a1a18;margin-bottom:6px;">No records yet</div>
                        <div class="text-muted" style="font-size:13px;">
                            Use the form on the right to log {{ $pet->name }}'s first medical record.
                        </div>
                    </div>
                @else
                    <div class="timeline">
                        @foreach($records as $rec)
                            ...
                            $rec->recordedBy->name }}</div>
                                        ...
                                        @if($rec->notes)
                                        <div class="tl-desc">{{ $rec->notes }}</div> @endif
