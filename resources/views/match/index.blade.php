...
<div class="page">
    ...
    <div class="two-col" style="align-items:start;">
        ...
        <div class="card">
            ...
            <div style="font-size:12px;color:#888;margin-bottom:16px;">Must-haves narrow the pool. Weights rank the
                results.</div>
            ...
            <form method="POST" action="{{ route('match.run') }}">
                ...
                <div class="form-group">
                    <div class="flex items-center justify-between">
                        ...
                        <span style="font-size:12px;font-weight:500;" id="lbl-{{ $key }}">{{ old('weights.'.$key,
                            $w['default']) }}</span>
                    </div>
        ...
        <div>
            ...
            @php $pet = $item['pet']; $score = $item['score']; @endphp
                ...
                <div class="card" style="{{ $i===0 ? 'border:1.5px solid var(--green);' : '' }}padding:14px 16px;">
                    <div class="flex items-center gap-12">
                        ...
                        <div style="flex:1;">
                            ...
                            <div style="font-size:12px;color:#888;">{{ $pet->breed ?? ucfirst($pet->species) }} · {{
